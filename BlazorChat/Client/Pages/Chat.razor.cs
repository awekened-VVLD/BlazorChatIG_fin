...
namespace BlazorChat.Client.Pages
{
    public partial class Chat
    {
        ...
        [Parameter] public bool isEditActive { get; set; }
        [Parameter] public long? idEditingMessage { get; set; }
        [Parameter] public string EditingMessage { get; set; }

        private List<ChatMessage> messages = new List<ChatMessage>();

        private void ActiveEditButton(ChatMessage message) 
        {
            isEditActive = true;
            idEditingMessage = message.Id;
        ...
        protected async Task DeleteMessage(long id, ChatMessage message)
        {
            message.Message = null;

            await _chatManager.DeleteMessageAsync(id, message);
        ...
        {
            message.Message = EditingMessage;
            
            await _chatManager.SaveMessageAsync(message);
            message.FromUserId = CurrentUserId;

            isEditActive = false;
            idEditingMessage = null;
        }
